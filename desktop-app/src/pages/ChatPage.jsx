...
function ChatPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-900">
      {/* Header */}
      <div className="flex-none border-b border-slate-700 bg-slate-800 px-6 py-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-white mb-1">AI Sales Assistant</h1>
            <p className="text-sm text-slate-400">
              Ask me anything about lead discovery, enrichment, or campaign automation
            </p>
          </div>
